...
section .data
    ...
    dword_arrays dd 1392, 12544, 7992, 6992, 7202, 27187, 28789, 17897, 12988, 17992
...
add_byte_array_element_word:
    mov dx, word [word_array + (ecx - 1) * 2]
    add eax, edx
    loop add_byte_array_element_word
...
add_byte_array_element_dword:
    mov edx, dword [dword_array + (ecx - 1) * 4]
    add eax, edx
    loop add_byte_array_element_dword
...
add_byte_array_element_dword_square:
    mov eax, dword [dword_arrays + (ecx - 1) * 4]
    mov edx, dword [dword_arrays + (ecx - 1) * 4]
    mul edx
    add ebx, eax
    loop add_byte_array_element_dword_square 
