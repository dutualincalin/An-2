...
HD_PWD='C:/Users/Calin/Desktop/Facultate/An 2/Sem 2/Calculatoare Numerice I/Laboratoare/Lab 1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sumator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sumator.tcl
