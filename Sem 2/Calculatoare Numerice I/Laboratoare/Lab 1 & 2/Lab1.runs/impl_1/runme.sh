...
HD_PWD='C:/Users/Calin/Desktop/Facultate/An 2/Sem 2/Calculatoare Numerice I/Laboratoare/Lab 1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sumator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sumator.tcl -notrace
